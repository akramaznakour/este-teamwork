<script>
    ...
    if (g.getDivId() != null) {
        ...
        g.setQuarterColWidth(1);
        g.setd
        g.setDateTaskDisplayFormat('day dd month yyyy'); // Shown in tool tip box
        g.setDayMajorDateDisplayFormat('mon yyyy ww') // Set format to display dates in the "Major" header of the "Day" view
        ...
        g.setUseSingleCell(7000); // Set the threshold at which we will only use one cell per table row (0 disables).  Helps with rendering performance for large charts.
