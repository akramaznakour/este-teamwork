        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default panel-with-tabs">
                    ...
                    <div class="tab-overflow overflow-right overflow-left">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="prev-button" style=""><a href="javascript:;" data-click="prev-tab" class="text-inverse"><i class="fa fa-arrow-left"></i></a></li>
                                ...
                                <li <?php if ($page == 'edit_project') { ?> class="active"<?php } ?> ><a href="#nav-tab2-1" data-toggle="tab">Edit project</a></li>
                                <li <?php if ($page == 'members_list') { ?> class="active"<?php } ?>><a href="#nav-tab2-2" data-toggle="tab">Members list</a></li>
                                <li <?php if ($page == 'create_task') { ?> class="active"<?php } ?>><a href="#nav-tab2-3" data-toggle="tab">Create a new task</a></li>
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-pane    <?php if  ($page == 'edit_project'){ ?>  active in <?php } ?>  "id="nav-tab2-1">
                            <?php include APP . 'view/project/partials/edit/edit_project.php'; ?>
                        </div>
                        ...
                        <div class="tab-pane    <?php if  ($page == 'create_task'){ ?>  active in <?php } ?>"  id="nav-tab2-3">
                            <?php include APP . 'view/project/partials/edit/create_task.php'; ?>
                        </div>
                        ...
                        <div class="tab-pane    <?php if  ($page == 'remaks'){ ?>       active in <?php } ?>"       id="nav-tab2-6">
